...
Gem::Specification.new do |s|
  ...
  s.authors = [%q{James A. Rosen}, %q{Ping Yu}, %q{Michael Bleigh}, %q{Erik Michaels-Ober}]
  s.date = %q{2011-04-29}
  s.description = %q{Enterprise strategies for OmniAuth.}
  s.email = [%q{james.a.rosen@gmail.com}, %q{ping@intridea.com}, %q{michael@intridea.com}, %q{sferik@gmail.com}]
